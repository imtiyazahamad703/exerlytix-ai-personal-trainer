...
const Footer = () => {
  ...
  // 🟣 Detect current path
  // Agar user dashboard page me hai to sidebar ke according margin-left set karenge
  const isDashboard = location.pathname.startsWith("/dashboard");

  return (
    <footer
      className={`bg-[#F3ECFF] text-slate-800 py-12 transition-all duration-300 ${
        isDashboard ? "ml-64 w-[calc(100%-16rem)]" : "w-full"
      }`}
    >
